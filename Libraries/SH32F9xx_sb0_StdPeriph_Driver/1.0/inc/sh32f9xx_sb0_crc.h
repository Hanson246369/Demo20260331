...
#ifndef __SH32F9XX_SB0_CRC_H
#define __SH32F9XX_SB0_CRC_H
...
/*! get last CRC value */
#define CRC_GetCRC()  (CRC->DR.V32)      

/*! reload CRC init value */
#define CRC_Reload()   (CRC_CR_RELOAD_BIT = SH_SET)
...
/* Fills each CRC_InitStruct member with its default value. */

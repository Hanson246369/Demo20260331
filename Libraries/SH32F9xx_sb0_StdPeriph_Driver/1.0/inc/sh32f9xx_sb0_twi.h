...
#ifndef __SH32F9XX_SB0_TWI_H
#define __SH32F9XX_SB0_TWI_H
...
{   
    ...
    TWI_CLKRATE_Type     PresClock              ;  /*!< Clock prescale: @ref TWI_CLKRATE_Type */
    TWI_CNT_Type         BusTimeOut             ;  /*!< Bus timeout count */

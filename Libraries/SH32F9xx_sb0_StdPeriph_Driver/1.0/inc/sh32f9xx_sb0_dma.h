...
#ifndef __SH32F9XX_SB0_DMA_H
#define __SH32F9XX_SB0_DMA_H
...
/**@enum DMA_STRMSEL_Type
  ...
  <tr><td>0   <td>UART0_TX    <td>UART0_RX    <td>UART1_TX    <td>UART1_RX    <td>UART2_TX    <td>UART2_RX      <td>UART3_TX      <td>UART3_RX
  <tr><td>1   <td>SPI0_TX     <td>SPI0_RX     <td>SPI1_TX     <td>SPI1_RX     <td>            <td>              <td>              <td> 
  ...
  <tr><td>3   <td>            <td>            <td>            <td>            <td>TIM5        <td>TIM6          <td>TIM7          <td>TIM8
  <tr><td>4   <td>ADC         <td>ADC         <td>ADC         <td>ADC         <td>UART4_TX    <td>UART4_RX      <td>UART5_TX      <td>UART5_RX
  <tr><td>5   <td>PCA0        <td>PCA0        <td>PCA1        <td>PCA1        <td>PCA2        <td>PCA2          <td>PCA3          <td>PCA3
  <tr><td>6   <td>PCA4        <td>PCA4        <td>PCA5        <td>PCA5        <td>PCA6        <td>PCA6          <td>PCA7          <td>PCA7
  <tr><td>7   <td>PWM0        <td>PWM1        <td>PWM2        <td>PWM3        <td>LED         <td>LED           <td>LED           <td>LED
  </table>
  */
typedef enum{
...
/**@enum DMA_STREAMSEL_CH0_Type
  ...
  */
typedef enum{
    STRMSEL_CH0_UART0_TX = DMA_STRMSEL_FUNC0, /*!< Channel0 Function0 */
    STRMSEL_CH0_SPI0_TX  = DMA_STRMSEL_FUNC1, /*!< Channel0 Function1 */
    STRMSEL_CH0_EXTI0    = DMA_STRMSEL_FUNC2, /*!< Channel0 Function2 */
    STRMSEL_CH0_EXTI1    = DMA_STRMSEL_FUNC2, /*!< Channel0 Function2 */
    STRMSEL_CH0_ADC      = DMA_STRMSEL_FUNC4, /*!< Channel0 Function3 */
    STRMSEL_CH0_PCA0     = DMA_STRMSEL_FUNC5, /*!< Channel0 Function5 */
    STRMSEL_CH0_PCA4     = DMA_STRMSEL_FUNC6, /*!< Channel0 Function6 */
    STRMSEL_CH0_PWM0     = DMA_STRMSEL_FUNC7, /*!< Channel0 Function7 */    
...
/**@enum DMA_STREAMSEL_CH1_Type
  ...
  */
typedef enum{
    STRMSEL_CH1_UART0_RX = DMA_STRMSEL_FUNC0, /*!< Channel1 Function0 */
    STRMSEL_CH1_SPI0_RX  = DMA_STRMSEL_FUNC1, /*!< Channel1 Function1 */
    STRMSEL_CH1_EXTI2    = DMA_STRMSEL_FUNC2, /*!< Channel1 Function2 */
    STRMSEL_CH1_EXTI3    = DMA_STRMSEL_FUNC2, /*!< Channel1 Function2 */
    STRMSEL_CH1_ADC      = DMA_STRMSEL_FUNC4, /*!< Channel1 Function4 */
    STRMSEL_CH1_PCA0     = DMA_STRMSEL_FUNC5, /*!< Channel1 Function5 */
    STRMSEL_CH1_PCA4     = DMA_STRMSEL_FUNC6, /*!< Channel1 Function6 */
    STRMSEL_CH1_PWM      = DMA_STRMSEL_FUNC7, /*!< Channel1 Function7 */    
...
typedef enum{
    ...
    STRMSEL_CH2_SPI1_RX  = DMA_STRMSEL_FUNC1, /*!< Channel2 Function1 */
    STRMSEL_CH2_EXTI4    = DMA_STRMSEL_FUNC2, /*!< Channel2 Function2 */
    STRMSEL_CH2_EXTI5    = DMA_STRMSEL_FUNC2, /*!< Channel2 Function2 */
    STRMSEL_CH2_ADC      = DMA_STRMSEL_FUNC4, /*!< Channel2 Function4 */
    STRMSEL_CH2_PCA1     = DMA_STRMSEL_FUNC5, /*!< Channel2 Function5 */
    STRMSEL_CH2_PCA5     = DMA_STRMSEL_FUNC6, /*!< Channel2 Function6 */
    STRMSEL_CH2_PWM2     = DMA_STRMSEL_FUNC7, /*!< Channel2 Function7 */    
...
typedef enum{
    ...
    STRMSEL_CH3_SPI1_RX   = DMA_STRMSEL_FUNC1, /*!< Channel 3 Function 1 */
    STRMSEL_CH3_EXTI6     = DMA_STRMSEL_FUNC2, /*!< Channel 3 Function 2 */
    STRMSEL_CH3_EXTI7     = DMA_STRMSEL_FUNC2, /*!< Channel 3 Function 2 */
    STRMSEL_CH3_ADC       = DMA_STRMSEL_FUNC4, /*!< Channel 3 Function 4 */
    STRMSEL_CH3_PCA1      = DMA_STRMSEL_FUNC5, /*!< Channel 3 Function 5 */
    STRMSEL_CH3_PCA5      = DMA_STRMSEL_FUNC6, /*!< Channel 3 Function 6 */
    STRMSEL_CH3_PWM3      = DMA_STRMSEL_FUNC7, /*!< Channel 3 Function 7 */
...
/**@enum DMA_STREAMSEL_CH4_Type
  ...
  */
typedef enum{
    STRMSEL_CH4_UART2_TX  = DMA_STRMSEL_FUNC0, /*!< Channel 4 Function 0 */
    STRMSEL_CH4_EXTI8     = DMA_STRMSEL_FUNC2, /*!< Channel 4 Function 2 */
    STRMSEL_CH4_EXTI9     = DMA_STRMSEL_FUNC2, /*!< Channel 4 Function 2 */
    STRMSEL_CH4_TIM5      = DMA_STRMSEL_FUNC3, /*!< Channel 4 Function 3 */
    STRMSEL_CH4_UART4_TX  = DMA_STRMSEL_FUNC4, /*!< Channel 4 Function 4 */
    STRMSEL_CH4_PCA2      = DMA_STRMSEL_FUNC5, /*!< Channel 4 Function 5 */
    STRMSEL_CH4_PCA6      = DMA_STRMSEL_FUNC6, /*!< Channel 4 Function 6 */
    STRMSEL_CH4_LED       = DMA_STRMSEL_FUNC7, /*!< Channel 4 Function 7 */
...
/**@enum DMA_STREAMSEL_CH5_Type
  ...
  */
typedef enum{
    STRMSEL_CH5_UART2_RX  = DMA_STRMSEL_FUNC0, /*!< Channel 5 Function 0 */
    STRMSEL_CH5_EXTI10    = DMA_STRMSEL_FUNC2, /*!< Channel 5 Function 2 */
    STRMSEL_CH5_EXTI11    = DMA_STRMSEL_FUNC2, /*!< Channel 5 Function 2 */
    STRMSEL_CH5_TIM6      = DMA_STRMSEL_FUNC3, /*!< Channel 5 Function 3 */
    STRMSEL_CH5_UART4_RX  = DMA_STRMSEL_FUNC4, /*!< Channel 5 Function 4 */
    STRMSEL_CH5_PCA2      = DMA_STRMSEL_FUNC5, /*!< Channel 5 Function 5 */
    STRMSEL_CH5_PCA6      = DMA_STRMSEL_FUNC6, /*!< Channel 5 Function 6 */
    STRMSEL_CH5_LED       = DMA_STRMSEL_FUNC7, /*!< Channel 5 Function 7 */
...
/**@enum DMA_STREAMSEL_CH6_Type
  ...
  */
typedef enum{
    STRMSEL_CH6_UART3_TX  = DMA_STRMSEL_FUNC0, /*!< Channel 6 Function 0 */
    STRMSEL_CH6_EXTI12    = DMA_STRMSEL_FUNC2, /*!< Channel 6 Function 2 */
    STRMSEL_CH6_EXTI13    = DMA_STRMSEL_FUNC2, /*!< Channel 6 Function 2 */
    STRMSEL_CH6_TIM7      = DMA_STRMSEL_FUNC3, /*!< Channel 6 Function 3 */
    STRMSEL_CH6_UART5_TX  = DMA_STRMSEL_FUNC4, /*!< Channel 6 Function 4 */
    STRMSEL_CH6_PCA3      = DMA_STRMSEL_FUNC5, /*!< Channel 6 Function 5 */
    STRMSEL_CH6_PCA7      = DMA_STRMSEL_FUNC6, /*!< Channel 6 Function 6 */
    STRMSEL_CH6_LED       = DMA_STRMSEL_FUNC7, /*!< Channel 6 Function 7 */
...
/**@enum DMA_STREAMSEL_CH7_Type
  ...
  */
typedef enum{
    STRMSEL_CH7_UART3_RX  = DMA_STRMSEL_FUNC0, /*!< Channel 7 Function 0 */
    STRMSEL_CH7_EXTI14    = DMA_STRMSEL_FUNC2, /*!< Channel 7 Function 2 */
    STRMSEL_CH7_EXTI15    = DMA_STRMSEL_FUNC2, /*!< Channel 7 Function 2 */
    STRMSEL_CH7_TIM8      = DMA_STRMSEL_FUNC3, /*!< Channel 7 Function 3 */
    STRMSEL_CH7_UART5_RX  = DMA_STRMSEL_FUNC4, /*!< Channel 7 Function 4 */
    STRMSEL_CH7_PCA3      = DMA_STRMSEL_FUNC5, /*!< Channel 7 Function 5 */
    STRMSEL_CH7_PCA7      = DMA_STRMSEL_FUNC6, /*!< Channel 7 Function 6 */
    STRMSEL_CH7_LED       = DMA_STRMSEL_FUNC7, /*!< Channel 7 Function 7 */
...
#define DMA_FLAG_ALL          (DMA_TRANS_BURST \
                               ...
                               | DMA_TRANS_ERROR)
/*!check DMA Flag */                               
#define IS_DMA_FLAG_Type(f)  (((f) == DMA_TRANS_COMPLETE) || ((f) == DMA_TRANS_HALF) \
                               ||((f) == DMA_TRANS_ERROR) ||((f) == DMA_TRANS_BURST))
/*!check All DMA Flags */       
...
/**@enum DMA_INT_Type
  ...
  */
typedef enum{
    DMA_INT_COMPLETE = DMA_CCR_TCIE_Msk, /*!< Transmit complete interrupt enable */
    DMA_INT_HALF     = DMA_CCR_HTIE_Msk, /*!< Half transmit complete interrupt enable */
    DMA_INT_BURST    = DMA_CCR_BEIE_Msk, /*!< Burst block transmit complete interrupt enable */
    DMA_INT_ERROR    = DMA_CCR_TEIE_Msk, /*!< Transmit error interrupt enable */
}DMA_INT_Type;
...
/*! @struct  DMA_InitTypeDef
  ...
  */ 
typedef struct{
    uint32_t  Enable            : 1;  /*!< DMA moulde SH_ENABLE or SH_DISABLE */
    uint32_t  TransCompleteIE   : 1;  /*!< transmit complete interrupt SH_ENABLE or SH_DISABLE */
    uint32_t  HalfCompleteIE    : 1;  /*!< Half transmit complete interrupt SH_ENABLE or SH_DISABLE */
    uint32_t  BurstCompleteIE   : 1;  /*!< One burst transmit complete interrupt SH_ENABLE or SH_DISABLE */
    uint32_t  TransErrorIE      : 1;  /*!< transmit error interrupt SH_ENABLE or SH_DISABLE*/
...
/*  Set the data source address in the current DMA channelx transmission. */

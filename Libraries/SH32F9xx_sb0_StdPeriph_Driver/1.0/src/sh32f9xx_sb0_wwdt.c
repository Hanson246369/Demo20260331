...
{
    RCC_APB1PeriphReset(RCC_APB0_WWDT);
}
...
void WWDT_EnableINT(bool_t EnableINT)
{
    ...
    tmpreg |= ((0x5AA5 << WWDT_CR_LOCK_Pos) | (EnableINT << WWDT_CR_WWDTIE_Pos));
...
/**
  ...
  * @retval The new state of the Early Wakeup interrupt flag (SH_SET or RESET)
  */

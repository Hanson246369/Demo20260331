...
/**
  ...
  *         This parameter can be one of the following values:
  *            @arg GPIO_AF_GPIO: Connect Pins to GPIO function AF1
  *            @arg GPIO_AF_UART0: Connect UART0 pins to AF2
  *            @arg GPIO_AF_UART1: Connect UART1 pins to AF2
  *            @arg GPIO_AF_UART2: Connect UART2 pins to AF2
  *            @arg GPIO_AF_UART3: Connect UART3 pins to AF2
  *            @arg GPIO_AF_UART4: Connect UART4 pins to AF2
  *            @arg GPIO_AF_UART5: Connect UART5 pins to AF2
  *            @arg GPIO_AF_SPI0: Connect SPI0 pins to AF3
  *            @arg GPIO_AF_TWI0: Connect TWI0 pins to AF3
  *            @arg GPIO_AF_SPI1: Connect SPI1 pins to AF4
  *            @arg GPIO_AF_TWI1: Connect TWI1 pins to AF4
  *            @arg GPIO_AF_PCA0: Connect PCA0 pins to AF5
  *            @arg GPIO_AF_PCA1: Connect PCA1 pins to AF5
  *            @arg GPIO_AF_PCA2: Connect PCA2 pins to AF5
  *            @arg GPIO_AF_PCA3: Connect PCA3 pins to AF5
  *            @arg GPIO_AF_PCA4: Connect PCA4 pins to AF5
  *            @arg GPIO_AF_PCA5: Connect PCA5 pins to AF5
  *            @arg GPIO_AF_PCA6: Connect PCA6 pins to AF5
  *            @arg GPIO_AF_PCA7: Connect PCA7 pins to AF5
  *            @arg GPIO_AF_TIM5: Connect TIM5 pins to AF6
  *            @arg GPIO_AF_TIM6: Connect TIM6 pins to AF6
  *            @arg GPIO_AF_TIM7: Connect TIM7 pins to AF6
  *            @arg GPIO_AF_TIM8: Connect TIM8 pins to AF6
  *            @arg GPIO_AF_PWM0: Connect PWM0 pins to AF7
  *            @arg GPIO_AF_PWM1: Connect PWM1 pins to AF7
  *            @arg GPIO_AF_PWM2: Connect PWM2 pins to AF7
  *            @arg GPIO_AF_PWM3: Connect PWM3 pins to AF7
  *            @arg GPIO_AF_LED:  Connect LED pins to AF8
  *            @arg GPIO_AF_ADC:  Connect ADC pins to AF8
  *            @arg GPIO_AF_LCD:  Connect LCD pins to AF9
  *            @arg GPIO_AF_TK:   Connect TK pins to AF10
  * @retval None
  */
void GPIO_PinAFConfig(GPIO_TypeDef *GPIOx, uint16_t GPIO_Pin, uint8_t GPIO_AF)
{
    ...
    while ((GPIO_Pin >> pinPos) != 0x00)
    {
        ...
        if ((GPIO_Pin & currentPin) == currentPin)
        {
            if (pinPos > 0x07)
            {
                GPIOx(CFG)->AFRH.V32 &= (~((uint32_t)0x0F << ((pinPos & 0x07) * 4)));
                GPIOx(CFG)->AFRH.V32 |= ((uint32_t)GPIO_AF << ((pinPos & 0x07) * 4));
            }
            else
            {
                GPIOx(CFG)->AFRL.V32 &= (~((uint32_t)0x0F << (pinPos * 4)));

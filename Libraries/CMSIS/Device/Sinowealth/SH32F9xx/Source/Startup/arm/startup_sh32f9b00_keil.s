;/*****************************************************************************/
;/* startup_sh32fxxx.s: Startup file for Sinowealth SH32Fxxx device series    */
;/*****************************************************************************/
;/* <<< Use Configuration Wizard in Context Menu >>>                          */ 
;/*****************************************************************************/
;/* This file is part of the uVision/ARM development tools.                   */
;/* Copyright (c) 2021 Keil Software. All rights reserved.               */
...
__Vectors
                         ...
                         DCD      Default_Handler      ;   1 (044H) Reserved
                         ...
                         DCD      ADC0_Handler         ;  11 (06CH) ADC0 Interrupt
                         DCD      ADC1_Handler         ;  12 (070H) ADC1 Interrupt
                         DCD      Default_Handler      ;  13 (074H) Reserved
                         DCD      GPT0_GTCIV_Handler   ;  14 (078H) GPT0 GTCIV Interrupt
                         DCD      GPT0_GTCIN_Handler   ;  15 (07CH) GPT0 GTCIN Interrupt
                         DCD      GPT1_GTCIV_Handler   ;  16 (080H) GPT1 GTCIV Interrupt
                         DCD      GPT1_GTCIN_Handler   ;  17 (084H) GPT1 GTCIN Interrupt
                         DCD      GPT2_GTCIV_Handler   ;  18 (088H) GPT2 GTCIV Interrupt
                         DCD      GPT2_GTCIN_Handler   ;  19 (08CH) GPT2 GTCIN Interrupt
                         DCD      GPT3_GTCIV_Handler   ;  20 (090H) GPT3 GTCIV Interrupt
                         DCD      GPT3_GTCIN_Handler   ;  21 (094H) GPT3 GTCIN Interrupt
                         DCD      GPT_POE_Handler      ;  22 (098H) GPT POE Global Interrupt
                         DCD      EXTI9_5_Handler      ;  23 (09CH) EXTI Line5 ~ Line9 global Interrupt
                         DCD      UART0_Handler        ;  24 (0A0H) UART0 Interrupt
                         DCD      MCM_FLT_Handler      ;  25 (0A4H) MCM FAULT Interrupt
                         DCD      MCM_PWM_Handler      ;  26 (0A8H) MCM PWM Interrupt
                         DCD      SPI0_Handler         ;  27 (0ACH) SPI0 Interrupt
                         DCD      SPI1_Handler         ;  28 (0B0H) SPI1 Interrupt
                         DCD      UART1_Handler        ;  29 (0B4H) UART1 Interrupt
                         DCD      UART2_Handler        ;  30 (0B8H) UART2 Interrupt
                         DCD      UART3_Handler        ;  31 (0BCH) UART3 Interrupt
                         DCD      UART4_Handler        ;  32 (0C0H) UART4 Interrupt
                         DCD      UART5_Handler        ;  33 (0C4H) UART5 Interrupt
                         DCD      EXTI15_10_Handler    ;  34 (0C8H) EXTI Line10 ~ Line15 Interrupt
                         DCD      TIM5_Handler         ;  35 (0CCH) TIM5 Interrupt
                         DCD      TIM6_Handler         ;  36 (0D0H) TIM6 Interrupt
                         DCD      TIM7_Handler         ;  37 (0D4H) TIM7 Interrupt
                         DCD      TIM8_Handler         ;  38 (0D8H) TIM8 Interrupt
                         DCD      TWI0_Handler         ;  39 (0DCH) TWI0 Interrupt
                         DCD      TWI1_Handler         ;  40 (0E0H) TWI1 Interrupt
                         DCD      TouchKey_Handler     ;  41 (0E4H) TouchKey Interrupt
                         DCD      QEI_Handler          ;  42 (0E8H) QEI Interrupt	 
                         DCD      CMP0_Handler         ;  43 (0ECH) CMP0 Interrupt	 
                         DCD      CMP1_Handler         ;  44 (0F0H) CMP1 Interrupt	 
                         DCD      CMP2_Handler         ;  45 (0F4H) CMP2 Interrupt	 
...
Default_Handler          PROC
                         ...
                         EXPORT   MCM_FLT_Handler      [WEAK]
                         EXPORT   MCM_PWM_Handler      [WEAK]
